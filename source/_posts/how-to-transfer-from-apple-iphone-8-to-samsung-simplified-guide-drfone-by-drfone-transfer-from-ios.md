---
title: How To Transfer From Apple iPhone 8 to Samsung Simplified Guide | Dr.fone
date: 2024-05-19T02:47:38.201Z
updated: 2024-05-20T02:47:38.201Z
tags: 
  - iphone transfer
categories:
  - ios
...
keywords: transfer data from iphone to samsung,transfer data from ios to samsung,transfer data from ios,export data from ios,transfer data from iphone,export data from iphone,transfer data from iphone to android,transfer data from ios to pc,transfer data from iphone to pc,transfer data from ios to android
...
Step 3. As soon as you connect the Apple iPhone 8 device, it will start recognizing it and mentioned it as the ‘Source’ phone or ‘Destination’ phone accordingly. In this case, make sure the Android phone is the Source, and the iPhone is the Destination. You can change their position using the Flip button.
...
- On your Apple iPhone 8, enter the 12-digit code of the iPhone. This is so that the ‘Move to iOS’ app knows which iOS device it has to transfer the data to.
...
- First, make sure Google Drive is already installed on the Android device. If not, visit the Play Store to download Google drive. Then, on your Apple iPhone 8, visit the Gallery section> select the images> tap on Share button> and finally choose Share via Drive.
